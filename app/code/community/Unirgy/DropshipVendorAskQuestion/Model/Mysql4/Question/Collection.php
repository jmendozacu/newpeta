...
class Unirgy_DropshipVendorAskQuestion_Model_Mysql4_Question_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function addPublicProductFilter($pId)
    {
        ...
        $this->addFieldToFilter('main_table.visibility',Unirgy_DropshipVendorAskQuestion_Model_Source::UDQA_VISIBILITY_PUBLIC);
