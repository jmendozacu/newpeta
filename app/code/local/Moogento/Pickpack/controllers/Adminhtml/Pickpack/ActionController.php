...
class Moogento_Pickpack_Adminhtml_Pickpack_ActionController extends Mage_Adminhtml_Sales_OrderController
{
    ...
    public function exportAction(){
		...
		$pdf = Mage::getModel('pickpack/sales_order_pdf_invoices_csvexportimport')->getCsvexport($data1);
		$pdf =  utf8_decode($pdf);
    ...
    public function setDefaultValues($country_name = '') {
        ...
        $this->default_config_values['show_description_box_dimension'] = '150,16';
        ...
        if($country_name == 'holland')
        {
            ...
            $this->default_config_values['label_width'] = 480;
            $this->default_config_values['label_height'] = 780;
        }   
        ...
        if($country_name == 'germany')
        {
            ...
            $this->default_config_values['show_description_box_dimension'] = '120,16';
            $this->default_config_values['show_description_nudge'] = '0,0';
        ...
        if($country_name == 'us')
        {
            ...
            $this->default_config_values['show_description_code'] = '';
            $this->default_config_values['show_description_number_of_lines'] = 4;
            $this->default_config_values['show_description_box_dimension'] = '120,18';
            $this->default_config_values['show_description_nudge'] = '0,0';
        ...
        if($country_name == 'uk')
        {
            ...
            $this->default_config_values['show_description_box_dimension'] = '120,16.5';
            $this->default_config_values['show_description_nudge'] = '0,0';
