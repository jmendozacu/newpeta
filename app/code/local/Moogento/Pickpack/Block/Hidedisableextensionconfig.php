...
class Moogento_Pickpack_Block_Hidedisableextensionconfig extends Moogento_Pickpack_Block_Adminhtml_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        //Show Sales Igniter Rental custom column?
        if(!Mage::helper('pickpack')->isInstalled('ITwebexperts_Payperrentals')){
            //PDF Packing Sheet
            $html .= "document.getElementById('row_pickpack_options_wonder_show_sales_igniter_rental_date').style.display = 'none';";
            $html .= "document.getElementById('row_pickpack_options_wonder_show_sales_igniter_rental_date_title').style.display = 'none';";
            $html .= "document.getElementById('row_pickpack_options_wonder_show_sales_igniter_rental_date_xpos').style.display = 'none';";
            //PDF Invoice
            $html .= "document.getElementById('row_pickpack_options_wonder_invoice_show_sales_igniter_rental_date').style.display = 'none';";
            $html .= "document.getElementById('row_pickpack_options_wonder_invoice_show_sales_igniter_rental_date_title').style.display = 'none';";
            $html .= "document.getElementById('row_pickpack_options_wonder_invoice_show_sales_igniter_rental_date_xpos').style.display = 'none';";
        }
