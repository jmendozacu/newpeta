    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element) {
        ...
        foreach ($element->getSortedElements() as $field) {
            ...
            //Product Price Line
            if (
                ($field->getId() == 'pickpack_options_wonder_product_line_base_prices_yn') ||
                ($field->getId() == 'pickpack_options_wonder_invoice_product_line_base_prices_yn')
            ...
            //Total Price
            if (
                ($field->getId() == 'pickpack_options_wonder_total_base_prices_yn') ||
                ($field->getId() == 'pickpack_options_wonder_invoice_total_base_prices_yn')
