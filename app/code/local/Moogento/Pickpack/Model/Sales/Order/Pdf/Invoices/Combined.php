	...
	*/
    ...
    public function getPickCombined($orders = array(), $output = 'order_combined'){
        ...
        if ($sort_packing == 'attribute') {
            ...
            $sort_packing_attribute = 'Mcategory';
        ...
        foreach ($process_list as $orderSingle) {
            ...
            foreach ($itemsCollection as $item) {
                ...
                $category_label= '';
                if ($sort_packing_attribute == 'Mcategory' || $sort_packing_secondary == 'Mcategory'){
                    ...
                    foreach ($catCollection as $cat) {
                        $_cat = Mage::getModel('catalog/category')->setStoreId($order->getStoreId())->load($cat->getId());
                        $cate_name = $_cat->getName();
                        if ($cate_name != '')
                            $categsToLinks[] = $cate_name;
                    }
                    $category_label = implode(', ', $categsToLinks);
                    $sku_master[$sku]['%category%'] = $category_label;
                }
