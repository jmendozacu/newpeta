    ...
    public function showCustomMessageText() {
        ...
        if ($message != null) {
            ...
            if ($this->message_yn == 'yesbox') {
                ...
                $maxWidthPage = ($positional_message_box_fixed_position_dimension_x);
                ...
                $custom_message_box_right = $custom_message_position[0] + $positional_message_box_fixed_position_dimension_x + 15;
