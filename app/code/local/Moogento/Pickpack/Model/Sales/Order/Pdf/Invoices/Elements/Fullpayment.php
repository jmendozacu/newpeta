        ...
        if(isset($full_payment) && $full_payment != ''){
            ...
            foreach ($full_payment_arr as $key => $payment_message) {
                ...
                if($payment_message != ''){
                    ...
                    $line_width = $this->parseString($payment_message, $font_temp, $this->generalConfig['font_size_body']); // bigger = left
                    ...
                    if(strlen($payment_message) > $max_chars){
                        ...
                        foreach ($message_arr as $value) {
                            ...
                            $this->packingsheetConfig['pickpack_show_full_payment_nudge'][1] -= ($this->generalConfig['font_size_body']);
                        }
                    }
                    else{
