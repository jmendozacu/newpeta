...
print "price,vendor_price,vendor_cost,sku,vendor_sku,qty,stock_qty,name,vendor_title,udropship_vendor,weight,manufacturer,status,tax_class_id,visibility,custom_stock_status,hide_default_stock_status\n";
...
$row->[4] =~ s/"/''/g;
			...
			binmode(STDOUT, ":utf8");
                        print "$row->[0],$row->[0],$costo,$row->[2],$row->[3],$row->[1],$row->[1],\"$row->[4]\",\"$row->[4]\",2,1,$row->[5],1,Productos Afectos a IVA,4,Despacho en 24 hrs.,1\n";
